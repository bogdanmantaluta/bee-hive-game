...
jest.mock('../components/QueenBee', () => ({
    QueenBee: jest.fn().mockImplementation(() =>
        createMockBee(100, QUEEN_DAMAGE_AMOUNT, true, BeeTypes.QUEEN)
    )
}));

jest.mock('../components/WorkerBee', () => ({
    WorkerBee: jest.fn().mockImplementation(() =>
        createMockBee(75, WORKER_DAMAGE_AMOUNT, false, BeeTypes.WORKER)
    )
}));

jest.mock('../components/DroneBee', () => ({
    DroneBee: jest.fn().mockImplementation(() =>
        createMockBee(50, DRONE_DAMAGE_AMOUNT, false, BeeTypes.DRONE)
    )
}));

jest.mock('../components/Bee', () => ({
    Bee: jest.fn().mockImplementation((health, damage, isBoss, type) =>
        createMockBee(health, damage, isBoss, type)
    )
}));
...
describe('Swarm', () => {
    ...
    describe('setSwarmState', () => {
        test('should correctly set swarm state from bee array', () => {
            ...
            swarm.setSwarmState(mockBees as Bee[]);
    ...
    describe('calculateSwarmHealth', () => {
        ...
        test('should calculate worker bee health correctly', () => {
            ...
            swarm.calculateSwarmHealth(workerBee as Bee);
            ...
            swarm.calculateSwarmHealth(lowHealthWorker as Bee);
        ...
        test('should calculate drone bee health correctly', () => {
            ...
            swarm.calculateSwarmHealth(droneBee as Bee);
            ...
            swarm.calculateSwarmHealth(lowHealthDrone as Bee);
        ...
        test('should calculate queen bee health correctly', () => {
            ...
            swarm.calculateSwarmHealth(queenBee as Bee);
            ...
            swarm.calculateSwarmHealth(lowHealthQueen as Bee);
    ...
    describe('hitRandomBee', () => {
        ...
        test('should end game when queen dies', () => {
            ...
            swarm.bees = [mockWorker as WorkerBee,mockQueen as QueenBee];
        ...
        test('should end game when all non-queen bees are dead', () => {
            ...
            swarm.bees = [mockQueen as Bee, mockDeadWorker as Bee];
